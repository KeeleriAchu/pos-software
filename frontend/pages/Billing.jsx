      ...
      <div>
        ...
        <div className="page-body">
            ...
            <div className="thermal-receipt">
              <div className="thermal-header">
                ...
                <p style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span>Bill: {billDone.bill.bill_number}</span>
                  <span>{d}</span>
                </p>
                <p style={{ textAlign: 'left', marginTop: '4px' }}>Customer: {billDone.billName || 'Walk-in'}</p>
                <div className="thermal-divider" />
              </div>
              
              <div style={{ fontWeight: 'bold', display: 'flex', borderBottom: '1px dashed black', paddingBottom: '4px', marginBottom: '6px' }}>
              ...
              {billDone.items.map((item, i) => (
                <div key={i} className="thermal-item">
                  ...
                  <div className="thermal-item-price" style={{ width: '70px', textAlign: 'right' }}>{item.total_price.toFixed(2)}</div>
                </div>
              ))}
              ...
              {discountAmt > 0 && (
                <div className="thermal-summary">
                  <span>Subtotal:</span>
                  <span>{(Number(billDone.bill.total_amount) + discountAmt).toFixed(2)}</span>
                </div>
              )}
              {discountAmt > 0 && (
                <div className="thermal-summary">
              ...
              <div className="thermal-summary thermal-summary-bold">
                <span>TOTAL:</span>
                <span>Rs {Number(billDone.bill.total_amount).toFixed(2)}</span>
              </div>
              ...
              <div className="thermal-summary">
                ...
                <span>Rs {Number(billDone.bill.paid_amount).toFixed(2)}</span>
              </div>
              <div className="thermal-summary">
                <span>Remaining:</span>
                <span>Rs {Math.max(0, Number(billDone.bill.total_amount) - Number(billDone.bill.paid_amount)).toFixed(2)}</span>
              </div>
          ...
          <div className="receipt-actions">
            <button className="btn btn-accent flex-1" onClick={() => setBillDone(null)}>+ New Bill</button>
